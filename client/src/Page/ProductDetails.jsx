...
const ProductDetails = () => {
    ...
    return product && (
        <div className="max-w-6xl mt-15 w-full px-6">
            <p>
                <Link to={"/"}>Home</Link> /
            ...
            <div className="mt-20 flex flex-col items-center">
                <div className="flex flex-col items-center w-max">
                    ...
                    <p className="font-semibold text-3xl sm:text-5xl">Related Products</p>

                </div>
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 md:gap-6 md:grid-cols-5 mt-6 ">
                ...
                <button onClick={() =>{navigate('/product'); scrollTo(0,0)}} className="mx-auto my-16 px-2 py-2.5 border rounded text-primary hover:bg-primary/10 transition">
                    See more
                </button>
            </div>
        </div>
